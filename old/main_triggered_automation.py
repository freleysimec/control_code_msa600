...
def main():
    ...
    for experimentIndex, experiment in myExperiments.iterrows():
        
        if not experimentIndex == "abreviation":    
            ...
            if not dieCoordinates[0] == "IGNORED":
                ...
                if inRange and inDiameter:
                    ...
                    myMeasurementOutput.save_measurement(experimentIndex, nameOfMSA600Filename)
                    nameOfMSA600Filename += 1
                    ...
                    myMeasurementOutput.save_measurement(experimentIndex, "IGNORED STRUCTURE")

            else:
                print("measurement Ignored because Die not in Range")
                ## SAVE performed measurement in "measurements done file" (anotate IGNORED under DIE)
                myMeasurementOutput.save_measurement(experimentIndex, "IGNORED")
