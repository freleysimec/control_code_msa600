...
#TODO: manual automation : manual based on excel file: based on Measurement Index
...
#TODO: how to easily give code to someone else: git (always update),
...
#TODO: better alternatives for venv
#TODO: more "settings" from userInput Excel
